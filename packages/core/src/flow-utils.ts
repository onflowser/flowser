...
export type FlowChainID = "flow-mainnet" | "flow-testnet" | "flow-emulator" | "flow-previewnet"
// Just a shorter version of the Chain ID.
export type FlowNetworkId = "mainnet" | "testnet" | "emulator" | "previewnet";
...
export class FlowUtils {
  ...
  static getContractBrowserAccountUrl(networkId: FlowNetworkId, address: string): string | undefined {
    switch (networkId) {
      case "emulator":
      case "previewnet":
        return undefined;
  ...
  static getFlowDiverAccountUrl(networkId: FlowNetworkId, address: string): string | undefined {
    switch (networkId) {
      case "emulator":
        return undefined;
      case "mainnet":
      ...
      case "previewnet":
        return `https://previewnet.flowdiver.io/account/${address}`
    }
  }
}
